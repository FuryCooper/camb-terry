    ...
    !        print *, 'dtauda NaN, grhoa2, grhok, grhoc, grhob, grhog', grhoa2, grhok, grhoc, grhob, grhog
    !        stop
    !endif
    ...
    !      if (isnan(sum(rhonu_m_a_massless(1:int_nu_massless))/int_nu_massless*grhornomass) .or. sum(rhonu_m_a_massless(1:int_nu_massless))/int_nu_massless*grhornomass<0.d0) then
    !    	  print *, 'dtauda NaN, grhoa2,grhonomass', grhoa2, sum(rhonu_m_a_massless(1:int_nu_massless))/int_nu_massless*grhornomass, sum(rhonu_m_a_massless(1:int_nu_massless)), int_nu_massless, grhornomass
    !    	  stop
    !      endif
    !endif
