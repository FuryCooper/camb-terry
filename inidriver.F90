    ...
    P%xi_nu(3) = Ini_Read_Double('xi_nu3') !Kenny: edited terry calculate xi1,xi2 from xi3
    P%xi_nu(4) = Ini_Read_Double('xi_nu4') !Kenny: edited terry calculate xi1,xi2 from xi3
    P%xi_nu_massless(1) = Ini_Read_Double('xi_nu_massless1') !terry
    P%xi_nu_massless(2) = Ini_Read_Double('xi_nu_massless2') !terry
    P%xi_nu_massless(3) = Ini_Read_Double('xi_nu_massless3') !terry
