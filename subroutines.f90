...
!
        implicit none
!        integer, parameter :: MAXITER=20 !!!Kenny: integration modification
!        integer, parameter :: MAXITER=25 !!!Kenny: integration modification
        integer, parameter :: MAXITER=30 !!!Kenny: integration modification
