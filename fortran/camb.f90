    ...
    P%xi_nu(3) = Ini%Read_Double('xi_nu3',0.d0) !Kenny: edited terry calculate xi1,xi2 from xi3
    P%xi_nu(4) = Ini%Read_Double('xi_nu4',0.d0) !Kenny: edited terry calculate xi1,xi2 from xi3
    P%xi_nu_massless(1) = Ini%Read_Double('xi_nu_massless1',0.d0) !terry
    P%xi_nu_massless(2) = Ini%Read_Double('xi_nu_massless2',0.d0) !terry
    P%xi_nu_massless(3) = Ini%Read_Double('xi_nu_massless3',0.d0) !terry
