    ...
    type, extends (TCAMBParameters) :: CAMBparams
        ...
        real(dl) :: xi_nu(4), omegan_for_mass !Kenny: edited terry
    ...
    if (omnuh2 > omnuh2_sterile) then
        ...
        if (neutrino_hierarchy == neutrino_hierarchy_degenerate) then
            ...
            if (this%Num_Nu_Massive==3) then
                ...
                !this%Nu_mass_eigenstates = 2 ! terry
                this%Nu_mass_degeneracies(1:3) = neff_massive_standard/3._dl ! terry
                m3 = mnu - 2*m1
                this%Nu_mass_fractions(1:2) = m1/mnu*normal_frac ! terry
                this%Nu_mass_fractions(3) = m3/mnu*normal_frac ! terry
                this%Nu_mass_numbers(1:3) = 1 ! terry
            else
